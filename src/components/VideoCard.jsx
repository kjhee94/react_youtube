...
export default function VideoCard({ video, type }) {
  ...
  return (
    <li
      className={isList ? 'flex gap-1 ml-6 mb-2' : ''}
    ...
    >
      ...
      />
      <div>
        <p className={isList ? 'text-sm mb-0.5 line-clamp-2' : 'mt-2 mb-0.5 line-clamp-2'}>{title}</p>
        <p className={isList ? 'text-xs opacity-60 line-clamp-1' : 'text-sm opacity-60 line-clamp-1'}>{channelTitle}</p>
